...
// void alloc_csr(int m, int n, int len_IA, int NZ, CSR *sparse)
// {
//     CSR sr = calloc(1, sizeof(struct _p_COO));
//     sr->m = m;
//     sr->n = n;
//     sr->NZ = NZ;
//     sr->IA = calloc(len_IA, sizeof(int));
//     sr->JA = calloc(NZ, sizeof(int));
//     sr->data = calloc(NZ, sizeof(double));
//     *sparse = sr;
// }
...
{
    int i, j, NZ;
    COO sp;// = malloc(sizeof(struct COO));
    NZ = 0;
